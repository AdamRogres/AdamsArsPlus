package com.adamsmods.adamsarsplus.perks;
...
@EventBusSubscriber(modid = AdamsArsPlus.MOD_ID, bus = EventBusSubscriber.Bus.MOD)
...
public class PerkAttributes {
    ...
    static {
        ATTRIBUTES = DeferredRegister.create(ForgeRegistries.ATTRIBUTES, AdamsArsPlus.MOD_ID);
