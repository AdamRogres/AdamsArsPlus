...
public class MattCastingBGoal<T extends Mob & RangedAttackMob> extends Goal {
    ...
    public MattCastingBGoal(MattEntity entity, double speed, float attackRange, Supplier<Boolean> canUse, int animId, int delayTicks) {
    ...
    void performCastAttack(LivingEntity entity, float p_82196_2_, Spell spell, ParticleColor color){
        ...
        this.mattEntity.castingBCooldown = random.nextInt(300) + 300;
    }
