...
public class CadeCastingBGoal<T extends Mob & RangedAttackMob> extends Goal {
    ...
    public CadeCastingBGoal(CadeEntity entity, double speed, float attackRange, Supplier<Boolean> canUse, int animId, int delayTicks) {
    ...
    public void tick() {
        ...
        if (livingentity != null) {
            ...
            if (this.hasAnimated) {
                ...
                if(isTimeToAttack()) {
                    performCastBAttack(this.cadeEntity, 1.0F, cadeCastBSpell, cadeColor);
