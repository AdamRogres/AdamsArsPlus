...
@OnlyIn(Dist.CLIENT)
public class TempRenderer extends EntityRenderer<BladeProjectile> {
    ...
    public TempRenderer(EntityRendererProvider.Context pContext) { super(pContext); }

    protected int getBlockLightLevel(BladeProjectile pEntity, BlockPos pPos) {
        return 15;
    }

    public void render(BladeProjectile pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
    ...
    public ResourceLocation getTextureLocation(BladeProjectile pEntity) {
