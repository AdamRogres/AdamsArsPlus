...
import static com.adamsmods.adamsarsplus.entities.AdamsModEntities.LIGHTNING_KNIGHT;
import static com.adamsmods.adamsarsplus.registry.ModRegistry.MAGE_TOME;

public class LightningMageKnight extends MageKnightEntity {

    public static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(LightningMageKnight.class, EntityDataSerializers.BOOLEAN);
    ...
    public static final EntityDataAccessor<Integer> INDEX =
            SynchedEntityData.defineId(LightningMageKnight.class, EntityDataSerializers.INT);

    public LightningMageKnight(EntityType<? extends Monster> pEntityType, Level pLevel){
        super(pEntityType, pLevel);
    }

    public LightningMageKnight(Level pLevel){
        this(LIGHTNING_KNIGHT.get(), pLevel);
    }
