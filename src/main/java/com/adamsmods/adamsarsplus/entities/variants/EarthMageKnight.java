...
import static com.adamsmods.adamsarsplus.entities.AdamsModEntities.EARTH_KNIGHT;
import static com.adamsmods.adamsarsplus.registry.ModRegistry.MAGE_TOME;

public class EarthMageKnight extends MageKnightEntity {

    public static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(EarthMageKnight.class, EntityDataSerializers.BOOLEAN);
    ...
    public static final EntityDataAccessor<Integer> INDEX =
            SynchedEntityData.defineId(EarthMageKnight.class, EntityDataSerializers.INT);

    public EarthMageKnight(EntityType<? extends Monster> pEntityType, Level pLevel){
        super(pEntityType, pLevel);
    }

    public EarthMageKnight(Level pLevel){
        this(EARTH_KNIGHT.get(), pLevel);
    }
