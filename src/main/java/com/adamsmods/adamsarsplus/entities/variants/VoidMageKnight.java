...
import static com.adamsmods.adamsarsplus.entities.AdamsModEntities.VOID_KNIGHT;
import static com.adamsmods.adamsarsplus.registry.ModRegistry.MAGE_TOME;

public class VoidMageKnight extends MageKnightEntity {

    public static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(VoidMageKnight.class, EntityDataSerializers.BOOLEAN);
    ...
    public static final EntityDataAccessor<Integer> INDEX =
            SynchedEntityData.defineId(VoidMageKnight.class, EntityDataSerializers.INT);

    public VoidMageKnight(EntityType<? extends Monster> pEntityType, Level pLevel){
        super(pEntityType, pLevel);
    }

    public VoidMageKnight(Level pLevel){
        this(VOID_KNIGHT.get(), pLevel);
    }
