...
public class EarthMageEntity extends MysteriousMageEntity implements RangedAttackMob {
    ...
    public static final EntityDataAccessor<Boolean> CASTING =
            SynchedEntityData.defineId(EarthMageEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public static final EntityDataAccessor<Integer> INDEX =
            SynchedEntityData.defineId(EarthMageEntity.class, EntityDataSerializers.INT);
