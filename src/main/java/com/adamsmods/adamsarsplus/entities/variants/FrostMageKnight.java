...
import static com.adamsmods.adamsarsplus.entities.AdamsModEntities.FROST_KNIGHT;
import static com.adamsmods.adamsarsplus.registry.ModRegistry.MAGE_TOME;

public class FrostMageKnight extends MageKnightEntity {

    public static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(FrostMageKnight.class, EntityDataSerializers.BOOLEAN);
    ...
    public static final EntityDataAccessor<Integer> INDEX =
            SynchedEntityData.defineId(FrostMageKnight.class, EntityDataSerializers.INT);

    public FrostMageKnight(EntityType<? extends Monster> pEntityType, Level pLevel){
        super(pEntityType, pLevel);
    }

    public FrostMageKnight(Level pLevel){
        this(FROST_KNIGHT.get(), pLevel);
    }
