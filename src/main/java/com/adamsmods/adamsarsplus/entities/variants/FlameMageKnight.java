...
import static com.adamsmods.adamsarsplus.entities.AdamsModEntities.FLAME_KNIGHT;
import static com.adamsmods.adamsarsplus.registry.ModRegistry.MAGE_TOME;

public class FlameMageKnight extends MageKnightEntity {

    public static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(FlameMageKnight.class, EntityDataSerializers.BOOLEAN);
    ...
    public static final EntityDataAccessor<Integer> INDEX =
            SynchedEntityData.defineId(FlameMageKnight.class, EntityDataSerializers.INT);

    public FlameMageKnight(EntityType<? extends Monster> pEntityType, Level pLevel){
        super(pEntityType, pLevel);
    }

    public FlameMageKnight(Level pLevel){
        this(FLAME_KNIGHT.get(), pLevel);
    }
    ...
    public void mageSpawn() {
        ...
        if (!CommunityMages.mages.isEmpty()) {
            try {
                ...
                try {
                    this.setIndex(7);
                    CommunityMages.ComMages communityMage = (CommunityMages.ComMages)CommunityMages.mages.get(7);
