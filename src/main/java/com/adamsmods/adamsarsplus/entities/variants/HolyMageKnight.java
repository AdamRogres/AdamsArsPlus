...
import static com.adamsmods.adamsarsplus.entities.AdamsModEntities.HOLY_KNIGHT;
...
public class HolyMageKnight extends MageKnightEntity {
    ...
    public static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(HolyMageKnight.class, EntityDataSerializers.BOOLEAN);
    ...
    public static final EntityDataAccessor<Integer> INDEX =
            SynchedEntityData.defineId(HolyMageKnight.class, EntityDataSerializers.INT);

    public HolyMageKnight(EntityType<? extends Monster> pEntityType, Level pLevel){
        super(pEntityType, pLevel);
    }

    public HolyMageKnight(Level pLevel){
        this(HOLY_KNIGHT.get(), pLevel);
    }
