...
import com.adamsmods.adamsarsplus.item.ArcaneRunes;
import com.adamsmods.adamsarsplus.item.EssenceItem;
import com.adamsmods.adamsarsplus.item.MagicItems;
import com.adamsmods.adamsarsplus.item.ManaCore;
import com.adamsmods.adamsarsplus.AdamsArsPlus;
import com.adamsmods.adamsarsplus.entities.EntityMissileSpell;
import com.adamsmods.adamsarsplus.entities.effects.AuraEffect;
...
public class ModRegistry {
    ...
    public static final RegistryObject<EntityType<? extends EntityMissileSpell>> ENTITY_MISSILE = ENTITIES.register("missile_spell_proj", () -> EntityType.Builder.<EntityMissileSpell>of(EntityMissileSpell::new, MobCategory.MISC).sized(0.9F, 3.0F).build(new ResourceLocation(AdamsArsPlus.MOD_ID, "missile_spell_proj").toString()));
