...
import static com.adamsmods.adamsarsplus.util.Util.CreateParticleBeam;
...
public class SonicBoom extends AbstractEffect implements IDamageEffect {
    ...
    public static final SonicBoom INSTANCE = new SonicBoom(new ResourceLocation(AdamsArsPlus.MOD_ID, "glyph_sound_boom"), "Sonic Boom");
