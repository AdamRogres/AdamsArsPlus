...
import com.adamsmods.adamsarsplus.util.Util;
...
public class GlyphMeteorite extends AbstractEffect implements IDamageEffect {
    ...
    public static final GlyphMeteorite INSTANCE = new GlyphMeteorite(new ResourceLocation(AdamsArsPlus.MOD_ID, "glyph_meteorite"), "Celestial Shower");
