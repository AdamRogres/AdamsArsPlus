...
public class DivineSmiteRenderer extends EntityRenderer<LightningBolt> {
        ...
        for(int j = 0; j < 4; ++j) {
            ...
            for(int k = 0; k < 3; ++k) {
                ...
                for(int j1 = l; j1 >= i1; --j1) {
                    ...
                    quad(matrix4f, vertexconsumer, f2, f3, j1, f4, f5, 0.45F, 0.45F, 0.2F, f10, f11, false, false, true, false);
                    quad(matrix4f, vertexconsumer, f2, f3, j1, f4, f5, 0.45F, 0.45F, 0.2F, f10, f11, true, false, true, true);
                    quad(matrix4f, vertexconsumer, f2, f3, j1, f4, f5, 0.45F, 0.45F, 0.2F, f10, f11, true, true, false, true);
                    quad(matrix4f, vertexconsumer, f2, f3, j1, f4, f5, 0.45F, 0.45F, 0.2F, f10, f11, false, true, false, false);
                }
            }
        }
    ...
    private static void quad(Matrix4f matrix, VertexConsumer consumer, float x1, float z1, int index, float x2, float z2, float red, float green, float blue, float p_115283_, float p_115284_, boolean p_115285_, boolean p_115286_, boolean p_115287_, boolean p_115288_) {
        consumer.addVertex(matrix, x1 + (p_115285_ ? p_115284_ : -p_115284_), (float)(index * 16), z1 + (p_115286_ ? p_115284_ : -p_115284_)).setColor(red, green, blue, 0.3F);
        consumer.addVertex(matrix, x2 + (p_115285_ ? p_115283_ : -p_115283_), (float)((index + 1) * 16), z2 + (p_115286_ ? p_115283_ : -p_115283_)).setColor(red, green, blue, 0.3F);
        consumer.addVertex(matrix, x2 + (p_115287_ ? p_115283_ : -p_115283_), (float)((index + 1) * 16), z2 + (p_115288_ ? p_115283_ : -p_115283_)).setColor(red, green, blue, 0.3F);
        consumer.addVertex(matrix, x1 + (p_115287_ ? p_115284_ : -p_115284_), (float)(index * 16), z1 + (p_115288_ ? p_115284_ : -p_115284_)).setColor(red, green, blue, 0.3F);
    }
