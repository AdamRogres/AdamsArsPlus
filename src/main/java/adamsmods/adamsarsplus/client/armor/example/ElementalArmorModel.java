...
public class ElementalArmorModel<T extends IElementalArmor & GeoItem> extends GeoModel<T> {
    ...
    public ElementalArmorModel(String name) {
        this.modelLocation = ResourceLocation.fromNamespaceAndPath(AdamsArsPlus.MODID, "geo/" + name + ".geo.json");
        this.textLoc = ResourceLocation.fromNamespaceAndPath(AdamsArsPlus.MODID, "textures/armor/" + name + ".png");
    }
