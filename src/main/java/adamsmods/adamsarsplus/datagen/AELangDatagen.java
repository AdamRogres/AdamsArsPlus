...
public class AELangDatagen extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("ars_elemental.page.spell_horn", "The Enchanter's Horn can be used to cast spells on you and nearby entities. Hold the Horn to increase the range, at max charge it will also give a Spell Damage effect to the player. It MUST be inscribed with a spell that does NOT have another method, using a Scribing Table.");
        ...
        for (FamiliarScript i : FamiliarRegistry.getFamiliarScriptMap().values()) {
            if (i.familiar.getRegistryName().getNamespace().equals(AdamsArsPlus.MODID)) {
        ...
        for (RitualTablet i : RitualRegistry.getRitualItemMap().values()) {
            if (i.ritual.getRegistryName().getNamespace().equals(AdamsArsPlus.MODID)) {
        ...
        for (PerkItem i : PerkRegistry.getPerkItemMap().values()) {
            if (i.perk.getRegistryName().getNamespace().equals(AdamsArsPlus.MODID) && !i.perk.getRegistryName().getPath().equals("blank_thread")) {
        ...
        for (Supplier<Glyph> supplier : GlyphRegistry.getGlyphItemMap().values()) {
            ...
            if (registryName.getNamespace().equals(AdamsArsPlus.MODID)) {
