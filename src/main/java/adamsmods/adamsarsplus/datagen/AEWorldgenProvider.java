...
import static adamsmods.adamsarsplus.world.example.ModWorldgen.COMMON_FLASHING_CONFIGURED;
...
public class AEWorldgenProvider extends DatapackBuiltinEntriesProvider {
    private static final RegistrySetBuilder BUILDER = new RegistrySetBuilder()
            ...
            .add(Registries.CONFIGURED_CARVER, ModWorldgen::bootstrapCaveCarvers)
    ...
    public AEWorldgenProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries, BUILDER, Set.of(AdamsArsPlus.MODID));
    }
    ...
    public static void generateBiomeModifiers(BootstrapContext<BiomeModifier> context) {
        ...
        HolderSet<Biome> FLASHJACK_SPAWN_TAG = context.lookup(Registries.BIOME).getOrThrow(AETagsProvider.AEBiomeTagsProvider.FLASHJACK_SPAWN_TAG);
