...
public class ArsProviders {
    ...
    public static class GlyphProvider extends GlyphRecipeProvider {
        ...
        public void collectJsons(CachedOutput cache) {
            ...
            recipes.add(get(EffectConjureArrow.INSTANCE).withItem(ADVANCED_CLOCKWORK,3).withItem(MANIPULATION_ESSENCE).withItem(ARROW).withItem(ELEMENTAL_SOUL));
    ...
    public static class EnchantingAppProvider extends ApparatusRecipeProvider {
        ...
        public void collectJsons(CachedOutput cache) {
            ...
            recipes.add(builder().withSourceCost(500).withPedestalItem(1, BASIC_SPELL_TURRET.asItem()).withReagent(ADVANCED_CLOCKWORK).withResult(AUTO_TURRET_BLOCK.asItem()).build());

            recipes.add(builder().withSourceCost(7000).withPedestalItem(3, GOLD_INGOT).withPedestalItem(2, REPEATER).withPedestalItem(1, MANA_DIAMOND).withPedestalItem(2, ADVANCED_CLOCKWORK).withReagent(CLOCK).withResult(ENCHANTERS_STOPWATCH).build());
