...
public class AdamsBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
    public AdamsBlockTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> future, ExistingFileHelper helper) {
        super(output, Registries.BLOCK, future, block -> block.builtInRegistryHolder().key(), AdamsArsPlus.MODID, helper);
    }

    public static TagKey<Block> BREAK_A = BlockTags.create(AdamsArsPlus.prefix("break_a"));
    public static TagKey<Block> BREAK_B = BlockTags.create(AdamsArsPlus.prefix("break_b"));
    public static TagKey<Block> BREAK_C = BlockTags.create(AdamsArsPlus.prefix("break_c"));
