...
public class ConfigHandler {
    ...
    public static class Common {
        ...
        public static ModConfigSpec.IntValue      MAX_DISCOUNTS;
        public static ModConfigSpec.IntValue      MAX_DOMAIN_ENTITIES;
        public static ModConfigSpec.BooleanValue  DOMAIN_BURNOUT;
        public static ModConfigSpec.BooleanValue  DISCOUNT_BACKLASH;
        public static ModConfigSpec.BooleanValue  COM_MAGES;
        public static ModConfigSpec.BooleanValue  LOCAL_MAGE_POOL;
        public static ModConfigSpec.BooleanValue  MAGES_GRIEF;
        public static ModConfigSpec.BooleanValue  DO_LEAP_FATIGUE;
        public static ModConfigSpec.ConfigValue<List<? extends String>> MAGE_DIMENSION_BLACKLIST;

        public static ModConfigSpec.IntValue      CADE_MAX_MANA;
        public static ModConfigSpec.DoubleValue   CADE_MANA_REGEN;
        public static ModConfigSpec.IntValue      CADE_SPELL_DAMAGE;
        public static ModConfigSpec.IntValue      CADE_WARDING;

        public static ModConfigSpec.IntValue      RYAN_MAX_MANA;
        public static ModConfigSpec.DoubleValue   RYAN_MANA_REGEN;
        public static ModConfigSpec.IntValue      RYAN_SPELL_DAMAGE;
        public static ModConfigSpec.IntValue      RYAN_WARDING;

        public static ModConfigSpec.IntValue      NICK_MAX_MANA;
        public static ModConfigSpec.DoubleValue   NICK_MANA_REGEN;
        public static ModConfigSpec.IntValue      NICK_SPELL_DAMAGE;
        public static ModConfigSpec.IntValue      NICK_WARDING;

        public static ModConfigSpec.IntValue      CAM_MAX_MANA;
        public static ModConfigSpec.DoubleValue   CAM_MANA_REGEN;
        public static ModConfigSpec.IntValue      CAM_SPELL_DAMAGE;
        public static ModConfigSpec.IntValue      CAM_WARDING;

        public static ModConfigSpec.IntValue      MATT_MAX_MANA;
        public static ModConfigSpec.DoubleValue   MATT_MANA_REGEN;
        public static ModConfigSpec.IntValue      MATT_SPELL_DAMAGE;
        public static ModConfigSpec.IntValue      MATT_WARDING;

        public static ModConfigSpec.IntValue      ADAM_MAX_MANA;
        public static ModConfigSpec.DoubleValue   ADAM_MANA_REGEN;
