...
import adamsmods.adamsarsplus.common.entity.example.ai.FollowOwnerGoal;
...
import static adamsmods.adamsarsplus.datagen.AETagsProvider.AEBiomeTagsProvider.FLASHING_BIOME;
...
public class Events {
    ...
    public static void focusDiscount(SpellCostCalcEvent event) {
        ...
        if (!caster.level().isClientSide() && caster instanceof Player player) {
            ...
            ISchoolFocus focus = ISchoolFocus.getFirstFocus(player);
