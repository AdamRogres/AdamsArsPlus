...
public class NueEntity extends FlyingMob implements IFollowingSummon, ISummon {
    ...
    class NueFollowSummonerGoal extends NueCircleAroundAnchorGoal{
    ...
    class NueCircleAroundAnchorGoal extends NueMoveTargetGoal {
        private float angle;
        ...
        public boolean canUse() {
            return NueEntity.this.getTarget() == null || NueEntity.this.attackPhase == AttackPhase.CIRCLE;
        }
    ...
    class NueSweepAttackGoal extends NueMoveTargetGoal {
        ...
        public boolean canUse() {
            return NueEntity.this.getTarget() != null && NueEntity.this.attackPhase == AttackPhase.SWOOP;
        }
        ...
        public void stop() {
            ...
            NueEntity.this.attackPhase = AttackPhase.CIRCLE;
        }
    ...
    class NueAttackStrategyGoal extends Goal {
        ...
        public void tick() {
            if (NueEntity.this.attackPhase == AttackPhase.CIRCLE) {
                --this.nextSweepTick;
                if (this.nextSweepTick <= 0) {
                    NueEntity.this.attackPhase = AttackPhase.SWOOP;
                    this.setAnchorAboveTarget();
