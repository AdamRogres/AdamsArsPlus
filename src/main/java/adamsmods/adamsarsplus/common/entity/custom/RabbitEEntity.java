...
public class RabbitEEntity extends Monster implements IFollowingSummon, ISummon {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new RabbitEPanicGoal(this, 2.2));
        this.goalSelector.addGoal(4, new FollowSummonerGoal(this, this.owner, (double) 1.0F, 25.0F, 3.0F));
        this.goalSelector.addGoal(4, new RabbitEAvoidEntityGoal(this, Player.class, 8.0F, 2.2, 2.2));
        ...
        this.targetSelector.addGoal(3, TenShadowsTargeting.unownedOnly(this, new HurtByTargetGoal(this, new Class[]{RabbitEEntity.class}) {
    ...
    private void enableJumpControl() {
        ((RabbitEJumpControl) this.jumpControl).setCanJump(true);
    }

    private void disableJumpControl() {
        ((RabbitEJumpControl) this.jumpControl).setCanJump(false);
    }
