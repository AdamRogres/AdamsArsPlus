...
public class DivineDogEntity extends Monster implements IFollowingSummon, ISummon {
    ...
    public void tick() {
        ...
        if(this.getSummoner() != null) {
            ...
            if (!this.level().isClientSide && this.isSummon && !adamsmods.adamsarsplus.util.TenShadowsState.active(this, this.getSummoner(), 0)) {
    ...
    protected void registerGoals(){
        ...
        this.targetSelector.addGoal(3, TenShadowsTargeting.unownedOnly(this, new HurtByTargetGoal(this, new Class[]{DivineDogEntity.class}) {
