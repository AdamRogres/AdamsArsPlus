...
public class CamAttackABGoal extends MeleeAttackGoal {
    ...
    public CamAttackABGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen, Supplier<Boolean> canUse) {
        ...
        if(isEnemyWithinAttackDistance(pEnemy, pDistToEnemySqr)) {
            ...
            if(isTimeToAttack()) {
                ...
                if(pEnemy.isBlocking()){
                    ...
                    performSpellAttack(this.mob, 1.0F, camAttackABSpell, camColor, pEnemy);
                }
            }
        } else {
            resetAttackCooldown();
