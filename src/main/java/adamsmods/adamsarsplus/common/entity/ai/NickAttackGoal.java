...
public class NickAttackGoal extends MeleeAttackGoal {
    ...
    public NickAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen, Supplier<Boolean> canUse) {
